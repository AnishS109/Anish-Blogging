...
const Comments = ({ post }) => {
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        const response = await fetch(`https://anish-blogging-2.onrender.com/get/comments/${post.title}`);
  ...
  const addComment = async () => {
    try {
      const response = await fetch("https://anish-blogging-2.onrender.com/comment/create-comment", {
        method: "POST",
